...
/*   Updated: 2018/02/13 00:37:15 by jonkim           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
double			ft_newton3_mu(t_env *env, t_thread *thd, double iter);
...
double			ft_sine_mu(t_env *env, double complex oz, double complex z,
				double iter);
